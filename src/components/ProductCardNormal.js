...
export default function ProductCardNormal({props}) {
    const {product} = props
            ...
            <Grid container spacing={4} justifyContent="center">
                ...
                <Grid item xs={12} sm={6} md={6} lg={6}>
                    ...
                    >
                        ...
                        <CardTypography props={{title: "No. of Orders:", content: (product.customersOrdered.length > 0 ? product.customersOrdered : 0)}} />
                    </Box>
                </Grid>
